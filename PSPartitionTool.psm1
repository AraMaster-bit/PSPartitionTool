...
#>
    ...
    try{
        Clear-Disk -Number $DiskNumber -RemoveData -RemoveOEM -ErrorAction Stop
    }   catch{
...
#>
    ...
    if ($PSCmdlet.ShouldProcess("Disk $DiskNumber", "The partitions will be cleaned and reformatted will be applied.")){
        try{
